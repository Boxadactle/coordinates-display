...
public class ColorConfigScreen extends Screen {
    ...
    public ColorConfigScreen(Screen parent) {
        ...
        this.pos = new Vector3d(Math.random() * 1000d, Math.random() * 5d, Math.random() * 1000d);
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Button(this.width / 2 - largeButtonW / 2, this.height - buttonHeight - p, largeButtonW, buttonHeight, Component.translatable("button.coordinatesdisplay.back"), (button) -> this.onClose()));

        // open wiki
        this.addRenderableWidget(new Button(5, 5, tinyButtonW, buttonHeight, Component.translatable("button.coordinatesdisplay.help"), (button) -> Minecraft.getInstance().setScreen(new ConfirmLinkScreen((yes) -> {
