...
public class DeathPosConfigScreen extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredTextWithShadow(matrices, this.textRenderer, Text.translatable("screen.coordinatesdisplay.config.deathpos", CoordinatesDisplay.MOD_NAME, version), this.width / 2, 5, ModUtil.WHITE);
        ...
        drawCenteredTextWithShadow(matrices, this.textRenderer, deathPos, this.width / 2, (int) (this.width / 1.5), ModUtil.WHITE);
    ...
    protected void init() {
        ...
        }, ModUtil.CONFIG_WIKI_DEATH, false)), MinecraftClient.getInstance().textRenderer));
    ...
    private void initButtons() {
        ...
        this.addDrawableChild(new ButtonWidget.Builder(Text.translatable("button.coordinatesdisplay.deathpos.deathscreen", (CoordinatesDisplay.CONFIG.displayPosOnDeathScreen ? ModUtil.TRUE : ModUtil.FALSE)), (button) -> {
            CoordinatesDisplay.CONFIG.displayPosOnDeathScreen = !CoordinatesDisplay.CONFIG.displayPosOnDeathScreen;
            button.setMessage(Text.translatable("button.coordinatesdisplay.deathpos.deathscreen", (CoordinatesDisplay.CONFIG.displayPosOnDeathScreen ? ModUtil.TRUE : ModUtil.FALSE)));
        ...
        // chunk data
        this.addDrawableChild(new ButtonWidget.Builder(Text.translatable("button.coordinatesdisplay.deathpos.chat", (CoordinatesDisplay.CONFIG.showDeathPosInChat ? ModUtil.TRUE : ModUtil.FALSE)), (button) -> {
            CoordinatesDisplay.CONFIG.showDeathPosInChat = !CoordinatesDisplay.CONFIG.showDeathPosInChat;
            button.setMessage(Text.translatable("button.coordinatesdisplay.deathpos.chat", (CoordinatesDisplay.CONFIG.showDeathPosInChat ? ModUtil.TRUE : ModUtil.FALSE)));
